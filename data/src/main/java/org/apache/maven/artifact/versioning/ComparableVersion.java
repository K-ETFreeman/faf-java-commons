...
public class ComparableVersion
  ...
  public static class StringItem
     ...
     * QUALIFIERS.size and then resort to lexical ordering. Most comparisons are decided by the first character, so this
     * is still fast. If more characters are needed then it requires a lexical sort anyway.
     *
     * @param qualifier
     *
